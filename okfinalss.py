...
def setup_processor():
    processor.ApplicationId = "twoocrtext"
    processor.Password = "DANuhfXhuuwyXuvjW/cWbmpt "
...
def main():
    ...
    while 0 <= id <= 299:
        ...
        no_box = browser.find_by_xpath('//*[@id="ctl00_ContentPlaceHolder1_drp_pagejump"]/option')  # getting option out using xpath
        ...
        if num_lines == 3 or num_lines == 2:
            ...
            try:
                ...
                f.write("--------------LESS ELEMENT ERROR (CASE 1)-------------------- \n ")
